...
def get_color(damage_category: str) -> list[int]:
...
def load_files():
    df6: pd.DataFrame = pd.read_csv("merged_df_h3_cell_6.csv")
    df7: pd.DataFrame = pd.read_csv("merged_df_h3_cell_7.csv")
    global GLOBAL_FILES
    GLOBAL_FILES["df6"] = df6
    GLOBAL_FILES["df7"] = df7
